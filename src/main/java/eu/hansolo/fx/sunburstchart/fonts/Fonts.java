...
package eu.hansolo.fx.sunburstchart.fonts;
...
public class Fonts {
    ...
    static {
        try {
            latoLightName              = Font.loadFont(Fonts.class.getResourceAsStream("/eu/hansolo/fx/sunburstchart/fonts/Lato-Lig.otf"), 10).getName();
            latoRegularName            = Font.loadFont(Fonts.class.getResourceAsStream("/eu/hansolo/fx/sunburstchart/fonts/Lato-Reg.otf"), 10).getName();
            latoBoldName               = Font.loadFont(Fonts.class.getResourceAsStream("/eu/hansolo/fx/sunburstchart/fonts/Lato-Bol.otf"), 10).getName();
